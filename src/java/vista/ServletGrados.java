...
public class ServletGrados extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
         ...
         BeanGrados busuario;
         busuario = new BeanGrados(Id_seccion, Grado,  Seccion ,  Status ,  Id_nivel );
         boolean sw=Grados.agregarUsuario(busuario);

         PrintWriter out=response.getWriter();
         out.println(Id_seccion +Grado + Seccion +Status +Id_nivel );

         
         if(sw){
                            response.sendRedirect("http://registrodealumnos.com:8084/Registro/Guardado.jsp");
